...
class LiquorsScreen extends StatefulWidget {
  const LiquorsScreen({Key? key}) : super(key: key);

  @override
  State<LiquorsScreen> createState() => _LiquorsScreenState();
}

class _LiquorsScreenState extends State<LiquorsScreen> {
  @override
