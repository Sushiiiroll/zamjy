...
class SoloMeals extends StatefulWidget {
  const SoloMeals({Key? key}) : super(key: key);

  @override
  State<SoloMeals> createState() => _SoloMealsState();
}

class _SoloMealsState extends State<SoloMeals> {
  @override
